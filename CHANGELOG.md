...
- Aligned contributor Rust requirements and local checks with CI.
- Documented PATH setup and the Linux binary's glibc 2.39 requirement, with
  Cargo installation guidance for older glibc and musl-based systems.
...
- Use Rust 1.98.1 consistently for release checks, binary builds, and publishing.
  The minimum supported Rust version remains 1.90.0.
