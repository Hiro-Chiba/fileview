...
2026年1月30日  v1.0.0   安定版リリース
     ↓
2026年2月3日   v1.18.0  フル機能版
     ↓
2026年2月3日   v1.22.0  Luaプラグイン完成
     ↓
2026年2月3日   v1.26.0  AI連携前夜（選択・セッション強化）
     ↓
2026年2月4日   v2.0.x-alpha  AIネイティブ高速進化
     ↓
2026年2月4日   v2.1.0   stable昇格
```
...
## Phase 7: AIネイティブ化と stable 昇格 (v1.23.0 - v2.1.0)

### v1.23.0 - 2026年2月3日 📱 狭幅ターミナル最適化

- ステータスバーのアダプティブ表示を強化
- ナロー環境での情報密度改善

### v1.24.0 - 2026年2月3日 🤖 Claude Code 連携基盤

- `--tree`, `--select-mode`, `--mcp-server` の実用導線を整備
- MCPツール群の初期提供でAIからの参照操作を実現

### v1.24.1 - 2026年2月3日 📚 AIドキュメント拡充

- `docs/CLAUDE_CODE.md` を中心に連携ガイドを強化
- 競合比較にAI統合軸を追加

### v1.25.0 - v1.25.2 - 2026年2月3日 🔧 安定化リリース

- 1.x系の品質改善と最終調整

### v1.26.0 - 2026年2月3日 🧩 AIワークフロー下準備

- セッション永続化（`--session save/restore/clear`）
- AI向け選択ショートカット群を拡充
- compact copy の導入

### v2.0.0-alpha - 2026年2月3日 🚀 MCP 2.0 / AIネイティブ開発機能

- MCP 2.0 ツール群（ファイル/Git/解析/依存/コンテキスト/プロジェクト）
- Unified Error Handling
- 大規模モジュール分割による保守性向上

### v2.0.1-alpha - 2026年2月3日 🔒 セキュリティ強化

- コマンド実行・パス検証・DoS対策を強化
- shell/path周りの防御を強化

### v2.0.2-alpha - 2026年2月4日 ⚡ 継続改善

- 2.xラインの機能改善と品質調整

### v2.0.3-alpha - 2026年2月4日 🧠 AIコンテキスト自動化強化

- context-pack preset/agent対応の拡張
- related-file選定、AI履歴メタデータ、AIベンチマークを強化

### v2.0.4-alpha - 2026年2月4日 🛡️ リリース前最終調整

- 依存セキュリティ方針の明文化（`cargo audit`運用）
- stable移行の最終ゲートを通過

### v2.1.0 - 2026年2月4日 ✅ stable 昇格

- `alpha` を外して `stable` チャネルへ移行
- `docs/STABILITY.md` で昇格条件を明文化
- 品質ゲート（check/clippy/test/audit）を連続通過

### 進行中（未リリース）

- `init claude`（Claude設定自動初期化）
- `--resume-ai-session [NAME]`（名前付きAIセッション復元）
- `Ctrl+Shift+Enter`（review context pack即時コピー）
- 日本語AI連携ガイド `docs/CLAUDE_CODE_ja.md`

これらは次リリース候補（PR #119）として進行中。

---

## リリース一覧（タグベース）

`v1.16.0`, `v1.17.0`, `v1.18.0`, `v1.19.0`, `v1.20.0`, `v1.21.0`, `v1.22.0`, `v1.23.0`, `v1.24.0`, `v1.24.1`, `v1.25.0`, `v1.25.1`, `v1.25.2`, `v1.26.0`, `v2.0.0-alpha`, `v2.0.1-alpha`, `v2.0.2-alpha`, `v2.0.3-alpha`, `v2.0.4-alpha`, `v2.1.0`
