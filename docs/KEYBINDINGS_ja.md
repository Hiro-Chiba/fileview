...
| `P` | サイドプレビューパネル切り替え |
| `o` | フルスクリーンプレビュー |
| `Tab` | サイドプレビューを閉じる / ディレクトリ展開切替 / ファイルプレビュー表示 |
| `←` / `→` | 折りたたみ / 展開（プレビュー表示中はフォーカス切替） |
| `[` | PDFの前のページ |
| `]` | PDFの次のページ |
...
| `Ctrl+Shift+Y` | AIコンテキストパックをコピー |
| `Ctrl+Enter` | レビュー用コンテキストパックをコピー |
| `Alt+Y` | コンパクト形式でコピー |
| `Ctrl+A` | AIフォーカスモード切り替え |
| `Alt+A` | AI追従モード切り替え（AI の直近ファイルに自動フォーカス） |
| `Alt+L` | ライブAI活動ログのポップアップを開く |
| `Ctrl+Shift+P` | AI履歴を開く |
